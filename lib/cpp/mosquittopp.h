...
class mosqpp_EXPORT mosquittopp {
	...
	public:
		...
		int tls_set(const char *cafile, const char *capath=NULL, const char *certfile=NULL, const char *keyfile=NULL, const char *enc_certfile=NULL, const char *enc_keyfile=NULL,int (*pw_callback)(char *buf, int size, int rwflag, void *userdata)=NULL);
